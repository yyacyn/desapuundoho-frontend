          ...
          {data.map((item, index) => (
            ...
            >
              <div className="flex gap-3 items-end h-full justify-center">
                {/* Pendapatan Bar */}
                <div
                  className={`w-10 rounded-t-md transition-all duration-300 cursor-pointer ${
                    hoveredBar?.type === "pendapatan" && hoveredBar?.year === item.year
                      ? "bg-emerald-400"
                      : "bg-emerald-500"
                  }`}
                ...
                <div
                  className={`w-10 rounded-t-md transition-all duration-300 cursor-pointer ${
                    hoveredBar?.type === "belanja" && hoveredBar?.year === item.year
                      ? "bg-red-400"
                      : "bg-red-500"
                  }`}
                          ...
                          <div className="relative w-full max-w-[280px] h-full overflow-visible">
                            <button
                              ...
                              className={`absolute left-0 right-0 bottom-0 rounded-t-md transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 ${
                                hoveredPendapatanBarId === item.id ? "bg-emerald-500" : "bg-emerald-600"
                              }`}
                              style={{
                        ...
                        <div key={item.id} className="flex-1 flex justify-center h-full items-end">
                          <div className="relative w-full max-w-[220px] h-full overflow-visible">
                            <button
                              type="button"
                              className={`absolute left-0 right-0 bottom-0 rounded-t-md transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 ${
                                hoveredBelanjaBarId === item.id ? "bg-emerald-500" : "bg-emerald-600"
                              }`}
                              style={{
                        ...
                        <div key={item.id} className="flex-1 flex justify-center h-full items-end">
                          <div className="relative w-full max-w-[320px] h-full overflow-visible">
                            <button
                              type="button"
                              className={`absolute left-0 right-0 bottom-0 rounded-t-md transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 ${
                                hoveredPembiayaanBarId === item.id ? "bg-emerald-500" : "bg-emerald-600"
                              }`}
                              style={{
